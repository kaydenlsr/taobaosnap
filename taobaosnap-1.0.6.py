...
from DecryptLogin.modules.utils import saveSessionCookies, loadSessionCookies

'''命令行参数解析'''
def parseArgs():
    parser = argparse.ArgumentParser(description='淘宝抢购脚本')
    parser.add_argument('--interval', dest='interval', help='抢购商品时查询商品是否可以购买的时间间隔(单位秒)', type=float, required=True)
...
class TaobaoSnap():
    ...
    def run(self):
        ...
        # print("good_infos: ",good_infos[good_id])
        time_seckill = "2022-03-11 20:59:59.99998888"
        # 对比时间，时间到的话就点击结算
        while True:
