...
'''淘宝抢购脚本'''
class TaobaoSnap():
    def __init__(self, trybuy_interval=1800, Seconds_kill_time=None, number=None):
...
if __name__ == '__main__':
    args = parseArgs()
    client = TaobaoSnap(trybuy_interval=args.interval ,Seconds_kill_time=args.time ,number=args.number)
